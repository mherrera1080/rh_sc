...
<div class="main p-3">
    ...
    <div class="page-header">
        <h3 class="fw-bold mb-3"><?= $data['modulo']['nombre_modulo']; ?></h3>
        <ul class="breadcrumbs mb-3">
            ...
            <li class="nav-item">
                <a href="#"><?= $data['modulo']['nombre_modulo']; ?></a>
            </li>
        </ul>
    </div>
    <div class="row">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        <h4 class="card-title"><?= $data['modulo']['nombre_area']; ?></h4>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <input type="hidden" id="area" value="<?= $data['modulo']['id_area']; ?>">
                        <table id="tablePlantilla" class="display table table-striped table-hover">
                            <thead>
                                <tr>
                                    <th>ID</th>
                                    <th>Contraseña</th>
                ...
                <div class="modal-body">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" class="form-control" value="<?= $data['modulo']['nombre_area']; ?>" disabled>
                            <input type="hidden" class="form-control" id="area" name="area" value="<?= $data['modulo']['id_area']; ?>">
                        </div>
                        <div class="col-md-3">
